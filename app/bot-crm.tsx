...
import { AlertTriangle, ArrowUpRight, BarChart3, Bot, BookOpen, Calendar, Check, CheckCheck, ChevronDown, Circle, Columns3, Copy, Database, ExternalLink, Eye, GripVertical, Inbox, Mail, Megaphone, Menu, MessageCircle, Mic, MoreHorizontal, Paperclip, Pause, Phone, Plus, RefreshCw, Search, Send, Settings, ShieldCheck, SlidersHorizontal, Smile, Tag, User, Users, Workflow, X, Zap } from "lucide-react";

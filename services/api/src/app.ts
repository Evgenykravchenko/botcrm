...
export class SystemController {
  ...
  @Get("health")
  @PublicRoute()
  async health() { return { status: "ok", service: "botcrm-api", version: "0.2.2", storage: this.core.storageMode(), database: await this.core.health(), queue: this.queue.status(), time: new Date().toISOString() }; }

...
export class PostgresStore {
  ...
  async createCampaign(workspace: string, input: { name: string; channel: Channel; content: string; buttons?: CampaignButton[]; mediaIds?: string[]; segmentId?: string; audience?: number; excluded?: number; scheduledAt?: string; timeZone?: string }) {
    const workspaceId = await this.workspaceId(workspace);
